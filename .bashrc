...
alias imv="imv -d"
alias yt='yt-dlp -i -c --add-metadata -o "~/Videos/%(uploader)s/%(title)s.%(ext)s"'
alias yta='yt-dlp -i --add-metadata -x --yes-playlist --embed-thumbnail --audio-format mp3 -o "~/Music/%(playlist)s/%(playlist_index)s - %(title)s.%(ext)s"'
alias ytbp='yt-dlp -i -c -r 512K --add-metadata --yes-playlist -o "~/Videos/%(playlist)s/%(playlist_index)s - %(title)s.%(ext)s"'
